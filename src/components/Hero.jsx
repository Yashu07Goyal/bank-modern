...
const Hero = () =>{
  return (
     <section id="home" className= {`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className ={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px_6`}>
        <div className="flex flex-row items-center py-[6x] px-4
        bg-discount-gradient rounded-[10px] mb-2">
          ...
          <div className="flex flex-row justify-between items-center w-full">
            ...
            <div className="ss:flex hiddem md:mr-4 mr-0">
              <GetStarted/>
