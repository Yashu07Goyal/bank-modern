  ...
  return (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      ...
      <div className="flex-1 flex flex-col justify-start mr-10">
        ...
        <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>A new way to make the payments easy, relaible
        and secure.</p>
 </div>
 <div className="flex-[1.5] w-full flex flex-row justify-between flex-wrap md:mt-0 mt-10">
  {footerLinks.map((footerLink) => (
    ...
    ss:my-0 my-4 min-w-[150px]">
      ...
      <div div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
     <p className="font-poppins font-normal text-center text-[18px] leading-[27px] text-white">
          2021 HooBank. All Rights Reseved.
        </p>
